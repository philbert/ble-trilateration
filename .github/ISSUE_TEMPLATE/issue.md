---
name: Issue
about: Create a report to help improve BLE Trilateration, or to get help with a problem you are having
---

<!-- Before you open a new issue:

Thanks for taking the time to report your issue. I'd much rather hear about it
and help find a solution than for you to give up on what BLE Trilateration might be able
to do for you.

Because BLE Trilateration is starting to get a bit popular, and because things can be a bit
...
the "Troubleshooting" page at https://github.com/philbert/ble-trilateration/wiki/Troubleshooting
...
on improving BLE Trilateration for all!

-->

## Configuration

<!-- Ideally paste screenshots of the config dialogs, from Config -> Devices and Services -> BLE Trilateration -> CONFIGURE,
...
In HA, Settings, Devices and Services, BLE Trilateration, click the three-dots and choose "Download Diagnostics.
...
If BLE Trilateration has been running a long time (several days) the diagnostics might take a long time
to generate. You can try reloading BLE Trilateration first (HA, Settings, Devices and Services, BLE Trilateration,
